...
<div class="card shadow-sm p-4 mb-4 d-flex flex-column justify-content-between"
    ...
    <form method="POST" action="{{ route('langues.store') }}">
        ...
        <div class="row mb-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control " name="codeLangue" placeholder="Ex: EN" required>
            </div>
        </div>
        ...
        <div class="row mb-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control " name="nom" placeholder="Ex: Anglais" required>
            </div>
        </div>
        ...
        <div class="row mb-5">
            ...
            <div class="col-sm-10">
                <textarea class="form-control " name="description" placeholder="Description de la langue"></textarea>
            </div>
        </div>

        <div class="d-flex justify-content-between mt-4">
            <a href="{{ route('langues.index') }}" class="btn btn-danger">
                Annuler
            </a>
