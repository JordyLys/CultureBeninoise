...
@section('title')
    <div class="row">
        <div class="col-sm-6"><h3 class="mb-0">Modifier un Type de média</h3></div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-end">
                <li class="breadcrumb-item"><a href="#">Type Médias</a></li>
...
<div class="card shadow-sm p-4 mb-4 d-flex flex-column justify-content-between"
   ...
   <form method="POST" action="{{ route('typeMedias.update', $typeMedia->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="row mb-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control " name="Nom" value="{{ old('nom', $typeMedia->nom) }}" required>
            </div>
        </div>
